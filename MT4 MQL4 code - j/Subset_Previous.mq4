...
//goto previous currency pair in array
...
{  
   ...
   sI--; 
   if (sI < 0) {sI = 19;}    //resets for scroll effect
   ...
   if (sI == 0) {PlaySound("bell.wav");}        //signals when first currency pair in subset is reached
